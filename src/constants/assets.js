...
export const ASSETS = {
  images: {
    ...
    banners: {
      ...
      studentBackground: '/images/sinh viên login.jpg',
    },
    cards: {
      studentAuth: '/images/sinh viên login.jpg',
      alumniAuth: '/image_60c16a.png',
      emailService: '/images/caplaimk.jpg',
      drivingService: '/images/laixe.jpg',
    },
    icons: {
      training: '/images/dvdt.jpg',
      online: '/images/hconl.jpg',
      faq: '/images/hoidap.jpg',
      tuition: '/images/hocphi.png',
      other: '/images/dvkhac.jpg',
    },
    avatars: {
