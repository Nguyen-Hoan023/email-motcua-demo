// SERVICE: motcuaService — Gọi Backend API 
...
const fetchAndNormalize = async (role) => {
  const listUrl = role === 'OFFICER'
    ? `${API_ROOT}/canbo/yeu-cau`
    : `${API_ROOT}/sv/yeu-cau`;

  const detailBase = role === 'OFFICER'
    ? `${API_ROOT}/canbo/yeu-cau`
    : `${API_ROOT}/sv/yeu-cau`;
